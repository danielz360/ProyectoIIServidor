...
import Rabol.CreacionArbolB;
import Rabol.Llavedos;
...
public class enlaceAB {
    ...
    Nodo_Detalle nuevo;
    Rabol.graphviz grafo = new Rabol.graphviz();
    ...
    public void insertar(String no,String fecha1,String total1,Object user,Nodo_Detalle detalle){
        ...
        Nodo_ColaCarrito nuevo = new Nodo_ColaCarrito(2);
